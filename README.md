...
### Personal Notes
Findings
I found that this mod was very straightforward when connecting it to the class content and example code. It provided me more hands on time working with python and MC which has made me feel more confident. I did find that when I faced an error or issue, I was able to consult the Python or Github community for answers. 

Outputs
From this homework, I can see how APIs are utilized in a real world context to build tools for compaines to sell that would benefit the lives of those purchasing the tools. 
